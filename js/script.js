...
window.onload = function () {
    ...
    function borrarProducto(borrar) {
        ...
        const idButton = evento.target.dataset.item;
    ...
    function calculoPrecioTotal() {
        ...
        DOMprecio.textContent = total.toFixed(4);
    }
    ...
    document.querySelector("#boton-eliminar").addEventListener('click', vaciarCarrito);
